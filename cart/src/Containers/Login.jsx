...
export default function Login({open, setOpen}) {
  ...
  const changeEmail = (vEmail) => {
    setEmail(vEmail.target.value);
  };
  const changePassword = (vPassword) => {
    setPassword(vPassword.target.value);
  };
